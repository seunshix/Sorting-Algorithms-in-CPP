...
private:
	...
	NodePtr treeSearch(NodePtr node, int key) {
...
int main() {
	...
	vector<int> instance;
	fstream inFile;
	inFile.open("RBT.inputFile.txt", ios_base::out | ios_base::in); 
	...
	for (int i = 0; i < 560; i++) {
		int number = randomNumber(generator); 
		inFile << number << "\n";
	}
